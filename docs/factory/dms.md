...
2. 输入手机号接收验证码。![DMS登录](DMS登录.png)
3. 输入验证码登录后会跳转到初始化密码页面，请在此页面完成密码初始化。
4. 登录后，会跳转至用户中心页面，再点击个人设置，可看到以DLR\_开头的系统用户名。![用户中心](用户中心.png)![个人设置](个人设置.png)
...
- 日常使用过程中，遇到问题可以在用户中心页面点击新DMS在线客服答疑，扫描二维码联系客服解决，他们是最专业的。![在线答疑](在线答疑.png)
- 用户中心页面有新DMS关联软件及APP安装包的下载连接。![下载连接页面](下载连接页面.png)
