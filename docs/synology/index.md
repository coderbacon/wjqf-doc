...
::: tip
直接双击桌面的快捷方式即可访问共享文件夹。本公司的所有计算机桌面上已经配置好了指向共享服务器的快捷方式，并配置好了Windows的凭据。只有在员工离职后，账户被禁用时，才需要重新配置Windows的凭据。![Windows凭据.png](Windows凭据.png)
:::
...
3. 常用的文件夹可以右击创建快捷方式，会在桌面创建一个图标，方便快速访问。![快捷方式](创建快捷方式.png)
